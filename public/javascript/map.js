...
function initMap() {
    ...
    var pairs = [{from: "GB", to:"AU"}, {from: "US", to: "SA"}];
//- pairs looks like
//-   [
//-     { to: "CC", from: "CC"},
//-     { to: "CC", from: "CC"},
//-     ...
//-   ]
    var donees = [{country: "AU", usd: 400, nets:46}, {country: "SA", usd: 100, nets: 10}];
//- donees looks like
//-   [
...
//-     ...
//-   ]
    var donors = [{ country: "GB", usd: 500, nets: 56 }, { country: "US", usd: 100, nets: 10 }];
//- donors looks like
//-   [
//-     { country: "CC", usd: number, nets: number },
//-     { country: "CC", usd: number, nets: number },
...
//code is a two letter country code string
    function countryObject(code) {
...
//to and from are two letter country code strings
    function drawArrow(to, from) {
        ...
        var fromObject = countryObject(from);
        var toObject = countryObject(to);
        var fromLat = fromObject.latitude;
        var fromLng = fromObject.longitude;
        var toLat = toObject.latitude;
        var toLng = toObject.longitude;
...
//country is a two letter country code string; usd and nets are numbers
    function createDoneeMarker(country, usd, nets) {
        var cObject = countryObject(country);
        var lat = cObject.latitude;
        var lng = cObject.longitude;
        var countryName = cObject.name;
